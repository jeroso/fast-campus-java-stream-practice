...
public class Chapter7Section1 {
    public static void main(String[] args) {
        ...
        User user2 = new User()
                .setId(1001)
                .setName("Alice")
                .setEmailAddress("alice@exmaple.com")
                .setVerified(false);

//        System.out.println(userEquals(user1, user2)); //error : nullPointerException
//        System.out.println(userEquals(user2, user1)); //정상 작동
        ...
        String email2 = maybeEmail2.orElse(someEmail);
